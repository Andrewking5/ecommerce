        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-16 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-2xl sm:text-4xl font-serif italic font-bold mb-8">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="aspect-[4/5] rounded-2xl sm:rounded-3xl overflow-hidden"
            >
              <OptimizedImage
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-2xl sm:text-4xl font-serif italic font-bold mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {VALUES.map((value, i) => (
              <motion.div
                ...
                className="p-5 sm:p-8 bg-ayers-cream rounded-2xl sm:rounded-3xl border border-ayers-ink/5 hover:border-ayers-gold transition-colors group text-center"
              >
          ...
          <div className="relative">
            ...
            {MILESTONES.map((ms, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className={`relative flex items-start mb-6 sm:mb-12 ${i % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}
              >
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-ayers-dark text-white rounded-2xl sm:rounded-3xl p-5 sm:p-8 md:p-12 flex flex-col md:flex-row items-center gap-8 mb-10"
          >
      ...
      <section className="py-24 text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="../collections"
              className="bg-ayers-gold text-white px-6 sm:px-10 py-4 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-opacity-90 transition-all"
            >
              {t('about.ctaCollections', '瀏覽系列')}
            </a>
            <a
              href="../customizer"
              className="border border-ayers-ink/20 text-ayers-ink px-6 sm:px-10 py-4 rounded-full text-xs font-bold uppercase tracking-widest hover:border-ayers-gold hover:text-ayers-gold transition-all"
            >
